...
Data: 19/02/2012
Descrição: Formulário de cadastro de planos
Versão: 1.0
*/
...
<body id="public">
	<form class="wufoo rightLabel" method="post" action="planos_salvar.php">
		<div class="info">
		...
		<ul>
			<li class="<?php if(!empty($erros['descricao'])): ?>error<?php endif; ?>"> <!-- esse class é utilizado para marcar a linha que está com erro: error (do CSS)-->
				...
				<div>
					<input name="descricao" type="text" class="field text small" value="<?php echo $plano->descricao; ?>" maxlength="255" tabindex="1" />
				</div>
				<div class="msg_erro">
