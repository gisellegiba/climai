...
<body id="public">
	<form class="wufoo rightLabel" method="post" action="funcionarios_salvar.php">
		<div class="info">
		...
		<ul>
			<li class="<?php if(!empty($erros['nome'])): ?>error<?php endif; ?>"> <!-- esse class é utilizado para marcar a linha que está com erro: error (do CSS)-->
				...
				<div>
					<input name="nome" type="text" class="field text small" value="<?php echo $funcionario->nome; ?>" maxlength="255" tabindex="1" />
				</div>
				<div class="msg_erro">
			...
			<li class="<?php if(!empty($erros['nr_conselho'])): ?>error<?php endif; ?>"> <!-- esse class é utilizado para marcar a linha que está com erro: error (do CSS)-->
				...
				<div>
					<input name="nr_conselho" type="text" class="field text small" value="<?php echo $funcionario->nr_conselho; ?>" maxlength="20" tabindex="1" />
				</div>
				<div class="msg_erro">
			...
			<li class="<?php if(!empty($erros['percentual'])): ?>error<?php endif; ?>"> <!-- esse class é utilizado para marcar a linha que está com erro: error (do CSS)-->
				...
				<div>
					<input name="percentual" type="text" class="field text small" value="<?php echo $funcionario->percentual; ?>" maxlength="4" tabindex="1" />(%)
				</div>
				<div class="msg_erro">
